...
View complete architecture diagrams and module designs:

- **[System Architecture](docs/architecture-diagrams.md)** - Complete system architecture diagrams and design documentation
- **[Module Architecture](docs/module-architecture.md)** - Detailed architecture diagrams for each functional module

#### Additional Architecture Diagrams Available:
1. Overall System Architecture
2. Microservices Architecture
3. Deployment Architecture (Kubernetes/Cloud Native)
